...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Afeez Amusa Onireke | Professional Ecosystem" },
      { name: "twitter:description", content: "Creating lasting value through writing, craftsmanship, enterprise technology, and education." },
    ],
  }),
  component: Index,
});
